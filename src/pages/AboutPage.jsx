    ...
    <main id="main-content" className="pt-16">
      ...
      <div className="bg-black text-white relative overflow-hidden min-h-[320px] flex items-center">
        ...
        <div className="absolute inset-y-0 right-0 w-1/2 hidden md:block">
          <img src={hero5Img} alt="" aria-hidden="true" className="w-full h-full object-cover" />
      ...
      <section aria-labelledby="who-we-are-heading" className="bg-white py-24 px-8">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="flex items-center gap-4 mb-6">
              <div className="w-8 h-px bg-red-700" aria-hidden="true" />
              {/* red-700 on white = 5.9:1 ✓ */}
              <span className="text-red-700 text-xs font-bold uppercase tracking-[.2em]">Who We Are</span>
            </div>
            <h2 id="who-we-are-heading" className="text-5xl font-black text-gray-900 uppercase leading-tight tracking-tight mb-6">
          ...
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-4 -left-4 w-full h-full border-2 border-red-600 -z-10 -rotate-1" aria-hidden="true" />
          </div>
        </div>
      </section>

      {/* Stats bar */}
      <section aria-label="Club stats" className="bg-black py-16 px-8">
      ...
      <section aria-labelledby="membership-heading" className="bg-gray-50 py-24 px-8">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center gap-4 mb-12">
            <div className="w-8 h-px bg-red-700" aria-hidden="true" />
            {/* red-700 on gray-50 = 5.9:1 ✓ */}
            <span id="membership-heading" className="text-red-700 text-xs font-bold uppercase tracking-[.2em]">Membership</span>
          </div>
              ...
              },
              {
                ...
                body: (
                  <>
                    ...
                    <a href="mailto:turlozb@miamioh.edu" className="text-red-700 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-red-700 rounded">
                      turlozb@miamioh.edu
                    </a>
      ...
      {/* Photo + CTA */}
      <section aria-labelledby="cta-heading" className="relative bg-black py-24 px-8 overflow-hidden">
        <img src={maxImg} alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover opacity-25" />
        <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-black/40" />
        <div className="relative max-w-3xl mx-auto text-center">
          <h2 id="cta-heading" className="text-5xl font-black text-white uppercase leading-tight tracking-tight mb-6">
          ...
          <Link
            ...
            className="inline-flex items-center gap-3 bg-red-700 hover:bg-red-600 text-white text-xs font-bold uppercase tracking-[.15em] px-10 py-4 transition-colors duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white rounded"
          >
            View the Schedule
